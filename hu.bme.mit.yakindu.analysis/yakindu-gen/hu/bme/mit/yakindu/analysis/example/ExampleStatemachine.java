...
public class ExampleStatemachine implements IExampleStatemachine {
	...
	public void runCycle() {
		...
		for (nextStateIndex = 0; nextStateIndex < stateVector.length; nextStateIndex++) {
			...
			case main_region_White:
				...
				break;
			case main_region_zsakutca:
				main_region_zsakutca_react(true);
				break;
			default:
				// $NullState$
			}
	...
	*/
	public boolean isStateActive(State state) {
		...
		case main_region_zsakutca:
			return stateVector[0] == State.main_region_zsakutca;
		default:
			return false;
		}
	}
	...
	*/
	...
	/* 'default' enter sequence for state zsakutca */
	private void enterSequence_main_region_zsakutca_default() {
		nextStateIndex = 0;
		stateVector[0] = State.main_region_zsakutca;
	}
	...
	/* Default exit sequence for state zsakutca */
	private void exitSequence_main_region_zsakutca() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	...
	private void exitSequence_main_region() {
		...
		case main_region_White:
			...
			break;
		case main_region_zsakutca:
			exitSequence_main_region_zsakutca();
			break;
		default:
			break;
		}
			...
			if (react()==false) {
				if (sCInterface.start) {
					...
					if (sCInterface.white) {
						exitSequence_main_region_Init();
						enterSequence_main_region_zsakutca_default();
					} else {
	...
	private boolean main_region_zsakutca_react(boolean try_transition) {
		boolean did_transition = try_transition;
